...
def get_options():
  ...
  parser.add_option('--analysis', dest='analysis', default='kl_C1reco', help="Analysis extension: required for doTrueYield (see ./tools/XSBR.py for example)")
