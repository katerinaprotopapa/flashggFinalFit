...
XSBRMap['kl_C1reco']['GG2H'] = {'mode':'constant', 'factor':XS['GG2H']}
XSBRMap['kl_C1reco']['TTH'] = {'mode':'constant', 'factor':XS['TTH']}
XSBRMap['kl_C1reco']['VBF'] = {'mode':'constant', 'factor':XS['VBF']}
XSBRMap['kl_C1reco']['WMINUSH'] = {'mode':'constant', 'factor':XS['WMINUSH2HLNU']+XS['WMINUSH2HQQ']}
XSBRMap['kl_C1reco']['WMINUSH2HLNU'] = {'mode':'constant', 'factor':XS['WMINUSH2HLNU']}
XSBRMap['kl_C1reco']['WMINUSH2HQQ'] = {'mode':'constant', 'factor':XS['WMINUSH2HQQ']}
XSBRMap['kl_C1reco']['WPLUSH'] = {'mode':'constant', 'factor':XS['WPLUSH2HLNU']+XS['WPLUSH2HQQ']}
XSBRMap['kl_C1reco']['WPLUSH2HLNU'] = {'mode':'constant', 'factor':XS['WPLUSH2HLNU']}
XSBRMap['kl_C1reco']['WPLUSH2HQQ'] = {'mode':'constant', 'factor':XS['WPLUSH2HQQ']}
XSBRMap['kl_C1reco']['ZH'] = {'mode':'constant', 'factor':XS['ZH2HQQ']+XS['ZH2HLL']+XS['ZH2HNUNU']} # not including ggZH in
XSBRMap['kl_C1reco']['ZH2HQQ'] = {'mode':'constant', 'factor':XS['ZH2HQQ']}
XSBRMap['kl_C1reco']['ZH2HLL'] = {'mode':'constant', 'factor':XS['ZH2HLL']}
XSBRMap['kl_C1reco']['ZH2HNUNU'] = {'mode':'constant', 'factor':XS['ZH2HNUNU']}
