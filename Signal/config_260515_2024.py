...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/vols/cms/jl2117/icrf/hgg/stxs/samples/Jun26/split_nlep_merged_GG_GJ_noMET_minimal_xgb_output_htc_all_systs_and_data/processed/nominal/%s'%_year,
